...
export default function PartnerCardHome({ partner }: { partner: Partner }) {
  ...
  return (
    ...
    >
      ...
      {/* Name */}
      <p className="font-semibold text-sm text-gray-900 group-hover:text-momo transition-colors line-clamp-1 px-4 w-full">
        {partner.name}
      </p>

      {/* Category + Rating */}
      <div className="flex items-center justify-center gap-2 px-4 mt-1 w-full">
