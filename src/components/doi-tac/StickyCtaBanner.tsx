    ...
    >
      <div className="max-w-3xl mx-auto px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold text-gray-900 truncate">{displayLabel}</p>
          <p className="text-xs text-gray-400 mt-0.5">Cashback · Ví Trả Sau 0% · Tích MoMo Xu</p>
        </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="flex-shrink-0 flex items-center gap-1.5 bg-momo text-white text-sm font-bold px-5 py-2.5 rounded-xl hover:bg-momo-dark transition-colors shadow-sm shadow-momo/30 whitespace-nowrap"
        >
          Mở MoMo
